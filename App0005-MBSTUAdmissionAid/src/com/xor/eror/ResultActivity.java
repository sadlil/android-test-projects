...
public class ResultActivity extends Activity {
	...
	public void init()
	{
		btnres = (ImageButton) findViewById(R.id.btnseeresult);
		webViewres = (WebView) findViewById(R.id.webViewres);
		...
		btnres.setOnClickListener(new OnClickListener() {
			...
			public void okconnectedtoInternet()
			{
				...
				*/
				...
				ArrayAdapter<String> adapter = new ArrayAdapter<String>(ResultActivity.this, android.R.layout.simple_spinner_dropdown_item, items);
				...
				builder.setPositiveButton("Check", new DialogInterface.OnClickListener() {
					...
					{
						url = "http://admission.brothers-jewellers.com/result.php?roll=" +r+"&unit="+u;
					...
					{		
						...
						protected void onPostExecute(String result) {
							...
							if( result != null)
							{
								...
								webViewres.setWebViewClient(new WebViewClient()
								{
					...
					public void onClick(DialogInterface dialog, int which) {
							...
							_dialogres =ProgressDialog.show(ResultActivity.this, "", "Please wait...");
					}
				});
			...
			public void onClick(View v) {
				...
				{
					showAlertDialog(ResultActivity.this, "No Internet Connection",
